...
public class Privacy extends Composite {
	static private Privacy _instance = null;
	...
	public Privacy(){
		...
		Label heading = new Label("Privacy");
		...
		HTML label = new HTML(new SafeHtmlBuilder().appendEscapedLines(res.text1().getText()).toSafeHtml());
